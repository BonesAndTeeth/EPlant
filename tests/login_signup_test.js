var random,name,email;

casper.test.begin('EPlant Functionality Tests', 19, function suite(test) {
	...
	*/
	 ...
	 */
	 ...
	 casper.wait(2000, function() {
	 	random = Math.floor(Math.random() * 70000000);
	 	name = "test_"+ "haha" + random;
	 	email = name + "@test.com";
	 ...
	 casper.wait(2000, function() {
		...
		test.assertEquals(this.getHTML('#loggedInItem'), 'Hi, '+name, "The user's username should show up after login");
